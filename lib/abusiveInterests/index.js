...
interest.getTotalValue = function () {
  return this.installmentValue * (1 - (1 / Math.pow(1 + this.monthlyInterest, this.length)) / this.monthlyInterest)
}

// P = total; r = taxa; n = número de pagamentos
// PMT = P * r / (1 - (1 / (1 + r)^n))
interest.getInstallmentValue = function () {
  return this.totalValue * this.monthlyInterest / (1 - (1 / Math.pow(1 + this.monthlyInterest, this.length)))
}
